...
//
val fizzbuzz : (IntRange) -> String = { x: IntRange -> x.map {
            if (it % 3 == 0 && it % 5 == 0)
                "FIZZBUZZ"
            else if (it % 3 == 0 && it % 7 == 0)
                "FIZZDOH"
            else if (it % 5 == 0 && it % 7 == 0)
                "BUZZDOH"
            else if (it % 3 == 0)
                "FIZZ"
            else if (it % 5 == 0)
...
val r2 : () -> String = { -> process("FOO") {r2_message + r2_message + r2_message}.uppercase() }
